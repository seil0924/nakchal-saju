...
export const PRODUCTS: Product[] = [
  ...
  {
    slug: 'jari', oh: 'to', hanja: '宅', name: '자리 사주',
    kicker: '事務室 移轉 方位',
    title: '사무실을 옮기기 전에, {b}어느 쪽인지부터{/b}',
    lead: '지금 자리의 문·책상 배치와 옮길 곳의 방위·거리, 이사에 좋은 날까지 함께 봅니다.',
    pains: [
    ...
    gives: [
      ...
      ['옮길 자리 방위', '지금 자리에서 몇 도 어느 쪽인지, 올해 조심하라 본 방면인지, 언제 풀리는지'],
      ['이사 택일과 시진', '앞으로 석 달 중 만·정·성·개에 드는 날과, 짐을 마칠 시간대까지'],
    ],
    href: '/jari', cta: '주소 넣고 방위 보기',
  },
];
