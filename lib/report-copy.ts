...
const CO={
 ...
 bi:{g:'比',grade:'대등(比肩)',cls:'el-non',score:'보통',gc:'#6f6a5c',
   t:'대등하게 맞서는 자리',
   p:['발주처와 대표님이 같은 <b>{M}</b> 기운입니다. 명리로 <b>비겁(比劫)</b> — 결이 비슷한 자리라, 우리만의 뚜렷한 우위가 없어 <b>경쟁이 치열해지기 쉬운 판</b>입니다.','인연이나 관계로 풀리는 자리가 아닙니다. 자격·실적·가격·기술점수 같은 <b>객관적 조건</b>으로 승부해야 하는 발주처입니다.','경쟁 업체가 몰리는 건이 많으니, 투찰 조건과 정량 요소에서 남보다 한 끗을 앞서 두는 준비가 낙찰을 가릅니다.']},
...
// 발주처(處) — 무료 기본(점수+기관 특성+요약 1문단) / 프리미엄(3계·시나리오·주의신호·세운)
