...
function twinHtml(tm:TyMatch, me:number, myDist:number[], myGan?:string){
  ...
  return `<div class="twinlead">대표님의 명을 세계 거장 100인과 견줬습니다.<br>`+
    ...
    `<div class="myeong"><div class="myl">${TYPE_NAME[me]} — ${TYPE_DESC[me]} 명</div>`+
      `<p>${TYPE_MYEONG[me]}</p>`+
      `<p class="mys">이 거장을 일으킨 것은 재능이나 운이 아니라 <b>바로 이 명</b>이었습니다. <b>${t.name}</b> — ${tm.story}</p>`+
      `<p class="mys2">맨손에서 시작해 <b>무에서 유를 이룬 사람</b>. 그 뿌리의 기운이, 대표님 여덟 글자와 같은 것입니다.</p></div>`+
    ...
    chips+
    `<div class="mecard"><div class="mel">그리고 — 대표님이 그 명입니다</div>`+
    ...
    `<p class="twinnote">※ 인물 명식은 널리 공개된 출생일 기준이며 생시는 미상이라 삼주로만 계산했습니다. 명식의 구조를 견준 것으로, 재미로 보는 유형 비교일 뿐 그분들의 삶이나 대표님의 운을 단정하는 것이 아닙니다.</p>`;
}
...
const DM_D1=[
 '나무의 기운은 위로 곧게 뻗으려는 성질입니다. 대표님이 남 밑에 오래 못 계시고 결국 당신 이름을 걸고 일을 벌이신 것도, 굽히기보다 뻗으려는 이 목의 본성 때문입니다.',
 '불의 기운은 사방을 밝히고 사람을 끌어모읍니다. 대표님이 계신 자리엔 늘 사람과 열기가 도는데, 이는 억지가 아니라 타고난 화의 발산력이 그렇게 만드는 것입니다.',
 '흙의 기운은 만물을 품고 자리를 지킵니다. 대표님이 화려함보다 신용과 뒷심으로 여기까지 오신 것은, 쉽게 흔들리지 않는 이 토의 무게 덕입니다.',
 '쇠의 기운은 벼려질수록 단단해지고 끊을 땐 확실히 끊습니다. 대표님이 결단이 빠르고 뒤끝 없이 매듭짓는 것은, 담금질로 완성되는 금의 본성입니다.',
 '물의 기운은 막히면 돌아가고 낮은 곳으로 스며듭니다. 대표님이 정면충돌보다 흐름을 읽어 파고드는 것은, 형세를 읽는 수의 지혜 때문입니다.'];
const DM_D2=[
...
const FIVE_S=[
 '넘치는 <b>목</b>은 “새로 벌이는 힘”입니다. 신규 사업·확장·개척에서 대표님을 따라올 사람이 드뭅니다. 다만 벌인 것을 다 끝맺기 전에 또 벌이면, 힘이 흩어져 뿌리가 얕아집니다.',
 '넘치는 <b>화</b>는 “사람을 끌고 드러내는 힘”입니다. 영업·홍보·대외 관계에서 강점이 분명합니다. 다만 과열되면 실속 없이 소문만 앞서니, 불길을 안으로 모으는 관리가 필요합니다.',
 '넘치는 <b>토</b>는 “버티고 신용을 쌓는 힘”입니다. 오래 가는 거래·기반 사업에서 무너지지 않습니다. 다만 지나치면 변화를 무겁게 여겨 때를 놓치니, 결단의 속도를 의식적으로 당기십시오.',
 '넘치는 <b>금</b>은 “끊고 결단하는 힘”입니다. 정리·구조조정·승부처에서 냉정하게 판을 가릅니다. 다만 지나치면 사람과 기회를 함께 베어 외로워지니, 벨 자리를 좁히십시오.',
 '넘치는 <b>수</b>는 “읽고 흐르는 힘”입니다. 정보·전략·위기관리에서 남보다 멀리 봅니다. 다만 지나치면 재기만 하다 실행이 늦으니, 뛰어들 한 번의 타이밍을 벼리십시오.'];
const FIVE_W=[
 '비거나 옅은 <b>목</b>은 “새로 뻗을 활로”가 아쉽다는 뜻입니다. 익숙한 것만 붙들기 쉬우니, 동쪽·초록·신규 시도로 뻗는 기운을 일부러 곁에 두십시오.',
 '비거나 옅은 <b>화</b>는 “드러내고 알리는 힘”이 아쉽다는 뜻입니다. 좋은 실력을 안에만 두기 쉬우니, 남쪽·붉은색·사람 만나는 자리로 온기를 채우십시오.',
 '비거나 옅은 <b>토</b>는 “든든한 기반과 안정”이 아쉽다는 뜻입니다. 판을 넓히기 전에 중심이 흔들리기 쉬우니, 중앙·노란색·실물 자산으로 뿌리를 내리십시오.',
 '비거나 옅은 <b>금</b>은 “끊고 매듭짓는 결단”이 아쉽다는 뜻입니다. 벌인 일을 못 정리해 끌기 쉬우니, 서쪽·흰색·명확한 마감 규칙으로 매듭의 힘을 채우십시오.',
 '비거나 옅은 <b>수</b>는 “돌아가고 물러설 여유”가 아쉽다는 뜻입니다. 정면으로만 부딪혀 지치기 쉬우니, 북쪽·검은색·쉬어가는 여백으로 융통을 채우십시오.'];
// 方 심화
const DIR_X=[
...
// ===== 발주처 궁합 =====
const CO={
 in:{g:'合',grade:'상생',cls:'el-mok',score:'매우 좋음',gc:'#177f5e',
   t:'발주처가 대표님을 밀어주는 자리',
   p:['발주처의 <b>{O}</b> 기운이 대표님의 <b>{M}</b> 기운을 살립니다. 명리로 <b>인성</b>의 관계 — 상대가 나를 키워주는, 궁합 중 가장 귀한 자리입니다.','이런 발주처와는 무리한 저가 없이도 흐름이 순하게 풀립니다. 대표님을 알아봐 주는 곳이니, 관계를 길게 보고 정성을 들이십시오.','다만 기대어 안주하기 쉬우니, 받은 만큼 실력으로 갚는다는 자세면 오래갑니다.']},
 jae:{g:'財',grade:'재물',cls:'el-to',score:'좋음',gc:'#b58a2f',
   t:'대표님이 결실을 가져오는 자리',
   p:['대표님의 <b>{M}</b> 기운이 발주처의 <b>{O}</b> 기운을 다스립니다. 명리로 <b>재성</b> — 내가 취하고 결실을 쥐는 관계로, 수주로 이어지기 좋은 궁합입니다.','실리가 분명한 자리이니 적극적으로 문을 두드릴 만합니다. 다만 급히 쥐려다 무리하면 탈이 나니, 페이스를 지키십시오.','계약 조건은 대표님이 주도권을 쥐기 유리한 구도입니다.']},
 bi:{g:'比',grade:'대등',cls:'el-non',score:'보통',gc:'#6f6a5c',
   t:'대등하게 맞서는 자리',
   p:['발주처와 대표님이 같은 <b>{M}</b> 기운입니다. 명리로 <b>비겁</b> — 결이 비슷한 자리라, 우리만의 뚜렷한 우위가 없어 <b>경쟁이 치열해지기 쉬운 판</b>입니다.','인연이나 관계로 풀리는 자리가 아닙니다. 자격·실적·가격·기술점수 같은 <b>객관적 조건</b>으로 승부해야 하는 발주처입니다.','경쟁 업체가 몰리는 건이 많으니, 투찰 조건과 정량 요소에서 남보다 한 끗을 앞서 두는 준비가 낙찰을 가릅니다.']},
 sik:{g:'食',grade:'베풂',cls:'el-hwa',score:'노력 필요',gc:'#b5402f',
   t:'대표님이 공을 들이는 자리',
   p:['대표님의 <b>{M}</b> 기운이 발주처의 <b>{O}</b> 기운으로 흘러 나갑니다. 명리로 <b>식상</b> — 내가 베풀고 공을 들이는 관계라, 정성만큼 돌아오기까지 시간이 걸립니다.','당장의 수주보다 신뢰를 쌓는 자리로 보십시오. 실적과 성의를 꾸준히 보이면 다음 건에서 열매를 맺습니다.','들인 공에 비해 회신이 더딜 수 있으니, 이 발주처 하나에 전부를 걸지는 마십시오.']},
 gwan:{g:'官',grade:'압박',cls:'el-su',score:'까다로움',gc:'#22406b',
   t:'발주처의 기준이 까다로운 자리',
   p:['발주처의 <b>{O}</b> 기운이 대표님의 <b>{M}</b> 기운을 누릅니다. 명리로 <b>관성</b> — 상대가 나를 통제하는 관계라, 기준이 엄격하고 절차가 까다롭게 느껴지는 자리입니다.','감정보다 서류와 원칙으로 다가가야 통합니다. 요구가 많더라도 정면으로 맞서기보다, 요건을 꼼꼼히 맞춰 신뢰를 얻는 편이 유리합니다.','한번 인정받으면 오래가는 곳이니, 초반의 깐깐함을 관문으로 여기고 넘으십시오.']}
};
// 동업/협정 공용 궁합 카피 ({A}=우리측, {S}=상대측)
// 동업 궁합 (대표×대표) — 사람 관계: 역할·신뢰·지분·의사결정
const DONGUP={
 in:{g:'合',grade:'상생',score:'좋음',gc:'#177f5e',
   t:'상대가 대표님을 받쳐주는 동업',
   p:['동업 상대의 <b>{O}</b> 기운이 대표님의 <b>{M}</b> 기운을 살립니다. 명리로 <b>인성</b> — 상대가 나를 세워주는 자리라, 대표님이 앞에서 밀고 상대가 뒤를 받치는 조합입니다.','억지로 맞추지 않아도 손발이 붙는 인연입니다. 다만 기대다 주도권을 통째로 넘기지 않게, 지분과 최종 결정권은 처음에 문서로 정하십시오.','성과가 나면 공을 나눠 돌리는 태도가 이 동업을 오래 가게 합니다.']},
 jae:{g:'財',grade:'재물',score:'좋음',gc:'#b58a2f',
   t:'대표님이 판을 쥐고 이끄는 동업',
   p:['대표님의 <b>{M}</b> 기운이 상대의 <b>{O}</b> 기운을 다스립니다. 명리로 <b>재성</b> — 대표님이 주도권을 쥐고 상대가 실무를 받치는 구도입니다.','지분·의사결정은 대표님 우위로 두는 편이 자연스럽습니다. 다만 아랫사람 대하듯 하면 금세 등을 돌리니, 대우와 몫은 넉넉히 챙기십시오.','대표님이 방향을 정하고 상대가 실행하는 역할 분담이 뚜렷할수록 돈이 됩니다.']},
 bi:{g:'比',grade:'대등',score:'보통',gc:'#6f6a5c',
   t:'두 대표가 정면으로 맞서는 동업',
   p:['상대와 대표님이 같은 <b>{M}</b> 기운입니다. 명리로 <b>비겁</b> — 둘 다 대표 기질이라, 맞으면 천군만마요 어긋나면 사사건건 부딪힙니다.','같은 걸 잘하고 같은 걸 못하니, 한 명은 안(관리·재무)을 한 명은 밖(영업·수주)을 맡아 영역을 아예 갈라야 시너지가 납니다.','의견이 갈렸을 때 누가 최종 결정을 하는지 규칙을 처음에 못박지 않으면, 위기에 반드시 터집니다.']},
 sik:{g:'食',grade:'베풂',score:'노력 필요',gc:'#b5402f',
   t:'대표님이 더 내주고 끌어주는 동업',
   p:['대표님의 <b>{M}</b> 기운이 상대의 <b>{O}</b> 기운으로 흘러 나갑니다. 명리로 <b>식상</b> — 대표님이 베풀고 끌어주는 관계라, 상대가 대표님 그늘에서 크는 그림입니다.','대표님이 리드하고 상대가 따라오는 구도면 잘 맞지만, 내주는 게 많으니 지분·보상으로 균형을 맞추지 않으면 대표님만 소진됩니다.','사람으로 키운다는 마음이면 오래가고, 당장의 손익만 따지면 대표님이 손해 보는 자리입니다.']},
 gwan:{g:'官',grade:'압박',score:'까다로움',gc:'#22406b',
   t:'상대가 판을 쥐는 동업',
   p:['상대의 <b>{O}</b> 기운이 대표님의 <b>{M}</b> 기운을 누릅니다. 명리로 <b>관성</b> — 상대의 스타일과 기준이 대표님을 조이는 구도입니다.','대표님이 2인자로 뒤를 받치는 편이 편하다면 나쁘지 않으나, 대등을 원하면 초반에 역할·권한·지분을 분명히 못박아야 눌리지 않습니다.','상대 페이스에 끌려가기 쉬우니, 중요한 결정일수록 감정보다 계약서로 대응하십시오.']}
};
// 협정 궁합 (회사×회사) — 공동도급: 주관사·지분·공종·관재수
const HYEOPJEONG={
 in:{g:'合',grade:'상생',score:'좋음',gc:'#177f5e',
   t:'상대 회사가 우리를 끌어올리는 결합',
   p:['상대 회사의 <b>{O}</b> 기운이 우리 법인의 <b>{M}</b> 기운을 살립니다. 명리로 <b>인성</b> — 자금·실적·신용 면에서 상대가 우리를 받쳐주는 결합입니다.','공동도급에서 우리가 덕을 보는 구도이니, 주관사 자리는 상대에게 양보하더라도 지분과 실리는 확실히 챙기는 편이 유리합니다.','상대의 간판·자격을 빌려 판을 키우는 그림이라, 우리 실적을 성실히 쌓아 다음 협정에서 대등해지는 것을 목표로 두십시오.']},
 jae:{g:'財',grade:'재물',score:'좋음',gc:'#b58a2f',
   t:'우리 회사가 주관사로 이끄는 결합',
   p:['우리 법인의 <b>{M}</b> 기운이 상대 회사의 <b>{O}</b> 기운을 다스립니다. 명리로 <b>재성</b> — 우리가 주도권을 쥐는 결합이라 주관사·대표사 포지션이 자연스럽습니다.','지분·의사결정을 우리 우위로 가져가되, 상대의 몫과 역할을 계약서에 분명히 보장해야 공사 후반까지 관계가 갑니다.','우리가 판을 짜고 상대가 실무를 대는 구조일 때 수익성이 가장 좋습니다.']},
 bi:{g:'比',grade:'대등',score:'보통',gc:'#6f6a5c',
   t:'체급이 비슷해 주관사를 다투는 결합',
   p:['두 회사가 같은 <b>{M}</b> 기운 — 체급과 색깔이 비슷한 결합입니다. 명리로 <b>비겁</b> — 대등해서 주관사 자리와 지분을 놓고 부딪히기 쉽습니다.','공동도급 지분·대표사·정산 방식을 계약서로 못박지 않으면, 공사 후반 준공·정산 단계에서 반드시 분쟁 소지가 생깁니다.','강점이 겹치니, 공종이나 구간을 아예 갈라 맡아야 중복과 마찰을 줄입니다.']},
 sik:{g:'食',grade:'베풂',score:'노력 필요',gc:'#b5402f',
   t:'우리가 기술·인력을 더 대는 결합',
   p:['우리 법인의 <b>{M}</b> 기운이 상대 회사의 <b>{O}</b> 기운으로 흘러 나갑니다. 명리로 <b>식상</b> — 우리가 기술·인력·실무를 더 대주는 결합입니다.','우리가 실질을 끌고 상대가 이름·자격을 대는 구조라면 맞물리지만, 소모가 크니 수수료·정산 조건을 냉정하게 잡으십시오.','당장의 도급 실적보다, 우리 기술이 다음 수주로 이어지는 레퍼런스가 되는지를 보고 결정하십시오.']},
 gwan:{g:'官',grade:'압박',score:'까다로움',gc:'#22406b',
   t:'상대 규모에 눌리기 쉬운 결합',
   p:['상대 회사의 <b>{O}</b> 기운이 우리 법인의 <b>{M}</b> 기운을 누릅니다. 명리로 <b>관성</b> — 규모·기준 면에서 상대가 우리를 압박하는 결합입니다.','상대가 주관사·주도권을 쥐기 쉬우니, 하도급으로 눌리지 않으려면 우리 역할·지분·책임 범위를 계약 초반에 분명히 못박아야 합니다.','공기 후반의 관재수를 조심하고, 정산·하자 책임 조건을 반드시 명문화하십시오.']}
};
...
const CO_X={
 in:['실전으로 그려 보면 — 이 발주처는 대표님의 서류를 유독 곱게 봐주고, 애매한 대목에서 우리 쪽에 유리하게 해석해 주는 자리입니다. 억지로 접대하지 않아도 결이 맞아 흐름이 순합니다.',
   ['<b>언제</b> — 이 발주처 건은 서두르지 말고 관계를 길게 보십시오. 한 건보다 다음 건, 그다음 건까지 이어지는 인연입니다.','<b>어떻게</b> — 저가로 승부하기보다 정성과 신뢰로 다가가면 오래갑니다. 받은 만큼 실력으로 갚는 태도가 이 인연을 지킵니다.','<b>무엇을</b> — 이 발주처의 발주 계획·사업 방향을 공식 공고·설명회로 미리 파악해 두면, 다음 건을 남보다 먼저 준비할 수 있습니다.'],
 ...
 bi:['실전으로 그려 보면 — 이 발주처 건은 우리와 체급·강점이 비슷한 업체가 몰려, 우위 없이 정면으로 붙는 <b>경쟁판</b>입니다. 관계로 앞서기 어려운 자리입니다.',
   ['<b>언제</b> — 인연·관계를 기대하지 말고, 적격 요건과 정량 점수를 완벽히 갖췄을 때 들어가십시오.','<b>어떻게</b> — 가격·기술점수·실적 등 객관 요소로 승부하십시오. 애매한 구두 정보에 기대지 말고 공고 조건 그대로 대응하십시오.','<b>무엇을</b> — 경쟁이 치열한 만큼, 적격심사·정량 항목에서 남들이 놓치는 감점 요소부터 메우는 쪽이 이깁니다.'],
   '주의 신호 — “이 정도면 되겠지”라는 방심이 가장 위험합니다. 우위가 없는 판일수록 서류 한 장·소수점 한 자리에서 갈리니, 마지막까지 정량 요소를 조이십시오.'],
 sik:['실전으로 그려 보면 — 이 발주처는 대표님이 공을 들이는 만큼 회신이 더딘 자리입니다. 정성을 쏟아도 당장의 수주로 돌아오지 않아 애가 탈 수 있습니다.',
   ...
   '주의 신호 — 한 건에 조급해 무리한 저가로 밀어붙이면 다음 기회까지 잃습니다. 이 발주처는 실적·신뢰가 쌓여야 문이 열리는 곳이니, 레퍼런스를 남기며 길게 접근하십시오.'],
...
const HYEOP_X={
 ...
 bi:['실전으로 그려 보면 — 두 회사가 체급과 색깔이 비슷해, 주관사 자리와 지분을 놓고 부딪히기 쉬운 결합입니다. 강점이 겹칩니다.',
   ['<b>주관사</b> — 주관사·대표사·정산 방식을 계약서로 못박지 않으면, 준공·정산 단계에서 반드시 분쟁이 생깁니다.','<b>지분</b> — 공종이나 구간을 아예 갈라 맡아 중복과 마찰을 줄이십시오.','<b>관재수</b> — 대등한 만큼 책임 소재가 흐려지기 쉬우니, 공종별 책임을 문서로 분리하십시오.'],
 ...
 gwan:['실전으로 그려 보면 — 이 협정은 상대의 규모·기준에 우리가 눌리기 쉬운 결합입니다. 상대가 주관사·주도권을 쥐기 쉽습니다.',
   ['<b>주관사</b> — 하도급으로 눌리지 않으려면, 우리 역할·지분·책임 범위를 계약 초반에 분명히 못박으십시오.','<b>지분</b> — 상대 페이스에 끌려 지분이 깎이지 않게, 최소 보장선을 계약서에 명시하십시오.','<b>관재수</b> — 공기 후반의 관재수를 조심하고, 정산·하자 책임 조건을 반드시 명문화하십시오.'],
...
function compatBlock(cm,c,otherLabel,ctx?,stepTitle?){
  ...
  if(X){
    deep=`<p>${X[0]}</p>`+
      `<div class="threekye"><div class="tkt">${stepTitle||'실전 3계'}</div>`+
...
// 발주처 — 무료 기본(점수+기관 특성+요약 1문단) / 프리미엄(3계·시나리오·주의신호·세운)
function baljuHtml(cm:any,c:any,otherLabel:string,tip:string|undefined,premium:boolean){
  const meCol=EL_HEX[GAN_ELc[c.dGan]],otCol=EL_HEX[cm.oel];
  ...
  if(!premium){
    ...
    const taste = X ? `<p>${X[0]}</p><div class="threekye"><div class="tkt">이 발주처를 대하는 3계 <span class="tkfree">첫 계 미리보기</span></div>`+
  ...
  const deep = X ? `<p>${X[0]}</p><div class="threekye"><div class="tkt">이 발주처를 대하는 3계</div>`+X[1].map((s2:string)=>`<div class="tkrow"><span class="tkdot"></span><span class="tktx">${s2}</span></div>`).join('')+`</div><p class="cwarn">${X[2]}</p>` : '';
...
function heroFor(c,s){
  ...
  const headline=up
    ? '오늘은 대표님 기운이 <b>투찰에 유리한</b> 흐름입니다'
    : '오늘은 눌리는 흐름 — <b>서두르기보다 때를 고르는</b> 편이 낫습니다';
  return {score,label:'오늘의 투찰 택일 신호',headline,
    sub:`${up?'상단':'하단'} 흐름 · 명식×일진 택일 지표(예측 아님)`,up};
}
...
// 세운 — 연도별 큰 흐름. 회사 명식 × 그해 간지 상성으로 8년치를 표로.
...
function cheobangHtml(s:Sajeong){
  ...
  const alt=up?'흐름이 꺾이거나 조건이 나쁘면, 무리하지 말고 이번 달 투찰 길일로 미루십시오.':'큰 건이라면 오늘 무리하기보다 이번 달 투찰 길일로 옮기는 편이 유리합니다.';
...
// 일진 × 대표 일간의 상성으로 8개 사업 유형을 배정한다.
const BIZ_TYPE:Record<string,{k:string;lb:string;full:string;c:string}> = {
  jae:  { k:'계약', lb:'계약·수주·수금', full:'계약·수주·수금에 좋은 날 — 결실의 기운이 드는 날입니다.', c:'#46a07d' },
  in:   { k:'채용', lb:'채용·면접·투자 검토', full:'채용·면접·투자 검토에 좋은 날 — 사람과 귀인이 드는 날입니다.', c:'#3f6fb0' },
  bi:   { k:'발표', lb:'신규 발표·중요 미팅', full:'신규 사업 발표·중요 미팅에 좋은 날 — 기운이 오르는 날입니다.', c:'#cfa64e' },
  sik:  { k:'영업', lb:'영업·홍보·소통', full:'영업·홍보·프레젠테이션에 좋은 날 — 표현이 트이는 날입니다.', c:'#3f8f80' },
  gwanY:{ k:'주의', lb:'갈등·지출 주의', full:'갈등·관재·큰 지출을 조심할 날 — 기운이 눌리는 날이니 무리한 결정을 피하십시오.', c:'#c0453a' },
...
function bizCalHtml(c:Chart,y:number,m:number,unlocked:boolean){
  ...
  return grid+`<div class="bizlist">${list}</div>`+
    `<p style="margin-top:12px">※ 일진과 대표님 일간(${GAN[c.dGan]})의 상성으로 산출한 참고 흐름입니다. 큰 계약·채용·발표는 표시된 좋은 날에, 무리한 결정은 주의·휴식일을 피해 잡으십시오.</p>`;
}
...
const WHY:Record<string,string>={jae:'결실의 기운이 들어 계약·수주·수금에 유리',in:'귀인이 들어 채용·면접·투자 검토에 유리',bi:'기운이 오르는 날이라 발표·중요 미팅에 유리',sik:'표현이 트여 영업·홍보·소통에 유리'};
function bizMonthDetail(c:Chart,y:number,m:number,d:number){
  ...
  return `<div class="bzsec"><div class="bzsh">◆ 이달 핵심 3일 — 큰 건은 이 날에</div>${topHtml}</div>`+
    ...
    `<p style="margin-top:12px">※ 오늘부터 30일, 일진과 대표님 일간(${GAN[c.dGan]})의 상성으로 산출한 흐름입니다. 큰 계약·채용·발표는 좋은 날에, 무리한 결정은 주의·휴식일을 피해 잡으십시오. 같은 좋은 날이라도 오전(진태양시) 기운이 더 맑습니다.</p>`;
}
...
// ── 가려진 값 미리보기 ──────────────────────────────
// 조사한 사주 사이트 대부분이 "??점 · ?월 · [?]명" 처럼 답의 모양은 보여 주고 값만 가린다(천명·헬로우봇·청월당).
// 규칙: 여기서 가리는 값은 모두 결제 후 같은 장에 그대로 나온다. 없는 값을 가려 궁금증만 만들지 않는다.
const QV=(n=2)=>`<b class="qv" aria-label="결제 후 공개">${'?'.repeat(n)}</b>`;
// 올해 달별 흐름 — 연간 캘린더(무료 요약·유료 본문)가 같은 계산을 쓴다
const MONTH_EL=[2,0,0,2,1,1,2,3,3,2,4,4]; // 1~12월 월지 오행 근사
function yearMonths(c:Chart){return MONTH_EL.map((el,i)=>({m:i+1,el,rel:relation(c.dayMasterEl,el)}));}
const REL_RANK:Record<string,number>={in:5,jae:4,sik:3,bi:2,gwan:1};
// 사업운 캘린더 · 연간 — 12개월 월운을 밀어주는 달/조여지는 달로 갈라 한눈에
...
const BY_DO:Record<string,string>={in:'미뤄둔 계약·투자·신규 수주를 이 달에 거십시오',jae:'수금·정산·계약 마무리를 몰아 실속을 굳히십시오',bi:'경쟁 입찰은 조건과 서류를 한 끗 앞서 준비하십시오',sik:'영업·홍보·제안서를 넓게 뿌리되 원가를 먼저 챙기십시오',gwan:'신규 확장은 미루고 인력·서류·시스템을 정비하십시오'};
const BY_DONT:Record<string,string>={in:'들어온 기회를 재다가 흘려보내는 것',jae:'벌여 둔 일 위에 새 일을 더 벌이는 것',bi:'과속 확장과 내부 지분·역할 다툼',sik:'마진 없는 수주와 무리한 지출',gwan:'무리한 차입·감정적인 계약·서두른 결정'};
function bizYearHtml(c:Chart,selYear:number,curM:number){
  ...
  for(let m=1;m<=12;m++){const el=MEL[m-1];const rel=relation(c.dayMasterEl,el);const info=BY_REL[rel]||BY_REL.bi;
    rows+=`<div class="myrow${m===curM?' now':''}"><span class="mym">${m}월${m===curM?'<em>이달</em>':''}</span>`+
      ...
      `<span class="myd">${BY_DESC[rel]}<em class="mydo">할 일 — ${BY_DO[rel]}</em><em class="mydont">피할 일 — ${BY_DONT[rel]}</em></span></div>`;}
  const ms=yearMonths(c);
  // 올해를 보는 중이면 지난 달은 승부처로 권하지 않는다 — 9월에 '5월에 계약하라'는 쓸모가 없다
  const ahead=ms.filter(x=>!curM||x.m>=curM);
  const top=[...ahead].sort((a,b)=>REL_RANK[b.rel]-REL_RANK[a.rel]||a.m-b.m).slice(0,3).sort((a,b)=>a.m-b.m);
  const tough=ahead.filter(x=>x.rel==='gwan').map(x=>x.m);
  const Q4=[[1,3],[4,6],[7,9],[10,12]].map(([a,b],qi)=>{const seg=ms.slice(a-1,b);const sc=seg.reduce((t,x)=>t+REL_RANK[x.rel],0);
    const tone=sc>=12?'밀어주는 분기 — 큰 건을 여기에 모으십시오':sc>=9?'고르게 흐르는 분기 — 계획대로 굴리십시오':'조여지는 분기 — 정비와 준비에 쓰십시오';
    return `<div class="bzwk"><span class="bzwkk">${qi+1}분기</span><div class="bzwkbd"><b>${a}~${b}월</b><em>${tone}</em></div></div>`;}).join('');
  const topHtml=top.map((x,i)=>`<div class="bztop"><span class="bztn">${i+1}</span><div class="bztbd"><b>${x.m}월 · ${BY_REL[x.rel][0]}운</b><em>${BY_DO[x.rel]}</em></div></div>`).join('');
...
function secDaepyoIntro(x:any):any[]{
  ...
  if(ss.length){
    out.push({mk:'符',tier:'free',t:`대표님 명식에 새겨진 부호 — ${ss.map(x=>x.name).join('·')}`,html:
      ...
      `</div></div>`).join('')+
      `</div>`+
      `<p style="margin-top:10px">신살은 여느 사람 사주엔 잘 안 드는 특수 부호입니다. 대표님껜 <b>${ss.map(x=>x.name).join('·')}</b>이(가) 함께 앉아, 남다른 승부 기질로 여기까지 오신 것입니다.</p>`});
  }
  return out;
}
// [率 사정률] 카테고리 섹션 빌더
function secSajeong(x:any):any[]{
  const {c,today,s,worryTxt,clientChart,legalChart,partnerChart,allyChart,level,names,daeunMeta,nowYMD,selYear,seunSelf,clientCore,me,gan,sip,dom,strong,weak,zero,P,unlocked,preciseOn,baljuPremium}=x;
  const out:any[]=[];
  // ── 무료 정점 → 가장 가벼운 결제(擇 990원) 순으로 배치 — 몰입 직후 첫 문턱을 낮게
  ...
  if(nowYMD){const gc0=gilCount(c,nowYMD.y,nowYMD.m);
    const left0=new Date(Date.UTC(nowYMD.y,nowYMD.m,0)).getUTCDate()-nowYMD.d;
    out.push({mk:'擇',tier:'taekil',teaser:`이번 달 <b>${nowYMD.m}월</b> 투찰 길일 <b>${gc0}일</b> — ${Array.from({length:Math.min(gc0,4)},()=>QV(2)+'일').join(' · ')}${gc0>4?' …':''} 정확한 날짜가 여기 있습니다. ${nowYMD.m}월은 <b>${left0}일</b> 남았습니다.`,t:`이번 달 투찰 길일 — ${nowYMD.m}월 택일`,html:choilHtml(c,nowYMD.y,nowYMD.m)});}
  return out;
}
// [曆 이달] 카테고리 섹션 빌더
function secCalendarMonth(x:any):any[]{
  ...
  if(nowYMD){
    ...
    const rd=rollDays(c,nowYMD.y,nowYMD.m,nowYMD.d);const rc:Record<string,number>={};rd.forEach(q=>{rc[q.key]=(rc[q.key]||0)+1;});
    out.push({mk:'曆詳',tier:'full',teaser:`큰 건을 걸 <b>핵심 3일</b>은 ${QV(2)}일 · ${QV(2)}일 · ${QV(2)}일 — 앞으로 30일 중 계약에 좋은 날 <b>${rc.jae||0}일</b>, 채용·투자 검토 <b>${rc.in||0}일</b>, 조심할 날 <b>${rc.gwanY||0}일</b>의 정확한 날짜와 주차별 전략이 여기 있습니다.`,t:`오늘부터 30일 상세 — 핵심 3일·주차별 전략`,html:bizMonthDetail(c,nowYMD.y,nowYMD.m,nowYMD.d)});
  }
  return out;
}
// [曆 연간] 카테고리 섹션 빌더
function secCalendarYear(x:any):any[]{
  ...
  {const yy=selYear||(nowYMD?nowYMD.y:2026); const cm=(nowYMD&&nowYMD.y===yy)?nowYMD.m:0;
   const ms=yearMonths(c); const ahead=ms.filter(q=>!cm||q.m>=cm); const good=ahead.filter(q=>q.rel==='in'||q.rel==='jae'); const tough=ahead.filter(q=>q.rel==='gwan');
   const lockedN=ahead.length-2; const span=cm?`남은 ${ahead.length}개월`:'12개월';
   const show=cm?[cm,cm%12+1]:[1,2];
   // 지난 달은 가려 봐야 궁금할 게 없다 — 올해면 이달부터 12월까지만 보인다
   const rowsF=ms.filter(q=>!cm||q.m>=cm).map(q=>show.includes(q.m)
     ?`<div class="myrow${q.m===cm?' now':''}"><span class="mym">${q.m}월${q.m===cm?'<em>이달</em>':''}</span><span class="mytag" style="background:${(BY_REL[q.rel]||BY_REL.bi)[1]}">${(BY_REL[q.rel]||BY_REL.bi)[0]}운</span><span class="myd">${BY_DESC[q.rel]}<em class="mydo">할 일 — ${BY_DO[q.rel]}</em></span></div>`
     :`<div class="myrow lockrow"><span class="mym">${q.m}월</span><span class="mytag qtag">${QV(2)}운</span><span class="myd">결제 후 공개</span></div>`).join('');
   out.push({mk:'曆年要',tier:'free',t:`${yy}년 한눈에 — 이달과 다음 달은 무료`,html:
     `<div class="bizsum"><div class="bsc"><span class="bsk mv">밀어주는 달</span><span class="bsv">${good.length}개월</span></div><div class="bsc"><span class="bsk av">조여지는 달</span><span class="bsv">${tough.length}개월</span></div><div class="bsc"><span class="bsk rt">고른 달</span><span class="bsv">${ahead.length-good.length-tough.length}개월</span></div></div>`+
     `<div class="bizyear"><div class="byhd">${yy}년 — ${span} 사업운 흐름</div>${rowsF}</div>`+
     `<p class="bizhint">나머지 ${lockedN}개월의 흐름과 달마다 할 일·피할 일, <b>승부처</b>와 분기별 운용은 아래 <b>연간 상세</b>에서 열립니다.</p>`});
   out.push({mk:'曆年',tier:'full',teaser:`${span} 중 밀어주는 달은 ${good.map(()=>QV(2)+'월').join(' · ')||'없음'} (${good.length}개월), 조여지는 달 <b>${tough.length}개월</b> — 달마다 할 일·피할 일과 <b>승부처 달</b>이 여기 있습니다.`,t:`${yy}년 12개월 사업운 흐름 — 밀어주는 달, 조여지는 달`,html:bizYearHtml(c,yy,cm)});}
  return out;
}
// [代 五決人財] 카테고리 섹션 빌더
...
function secDaeun(x:any):any[]{
  ...
  if(legalChart){const lr=legalReport(c,legalChart);const nm=names.legal?`${names.legal} — `:'';
    ...
    if(daeunMeta&&daeunMeta.foundYear){const d=daeun(legalChart,daeunMeta.foundYear,daeunMeta.curYear);
      ...
      const yrs=Array.from({length:8},(_,i)=>relation(d.me,seunYear(daeunMeta.curYear+i).el));
      const upN=yrs.filter(r=>r==='in'||r==='jae').length, dnN=yrs.filter(r=>r==='gwan').length;
      const sy0=seunYear(daeunMeta.curYear); const r0=relation(d.me,sy0.el);
      out.unshift({mk:'今',tier:'free',t:`${names.legal||'회사'}${josa(names.legal||'회사','는')} 지금 ${curB.from}~${curB.to}년차 구간`,html:P([
        `설립 <b>${d.age}년차</b> — 지금은 <b>${GAN[curB.gan]}${ZHI[curB.zhi]}</b> 대운입니다. ${DAEUN_REL[relc]}.`,
        `<b>${daeunMeta.curYear}년</b>은 <b>${SEUN_REL[r0][0]}</b>입니다. ${SEUN_REL[r0][1]}.`,
        `앞으로 8년 중 회사를 밀어주는 해가 <b>${upN}번</b>, 조이는 해가 <b>${dnN}번</b> 있습니다.`+(nextUp?` 다음에 밀어주는 대운은 설립 ${QV(2)}년차부터입니다.`:''),
        `그 해가 언제인지, 그리고 이 회사가 대표님을 받치는지 누르는지는 아래에서 열립니다.`])});
      out.push({mk:'運',tier:'full',teaser:`앞으로 8년 중 밀어주는 해 <b>${upN}번</b> — ${yrs.map((r,i)=>(r==='in'||r==='jae')?QV(4)+'년':'').filter(Boolean).slice(0,3).join(' · ')} 그 해가 언제인지와 다음 10년 확장·정비의 때가 여기 있습니다.`,t:`${names.legal||'회사'}의 대운 — 지금은 ${d.list[d.curBlock].from}~${d.list[d.curBlock].to}년차`,html:daeunSectionHtml(d,names.legal,daeunMeta.curYear)});}}
  return out;
}
// [宮 발주처] 카테고리 섹션 빌더
function secBalju(x:any):any[]{
  ...
  if(clientChart){const cm=compat(c,clientChart,seunSelf);const nm=names.client?`${names.client} — `:'';
    // 무료 진입(점수+기관 특성+요약) → 발주처 프리미엄 패스로 상세 전체 열람
    const tip=clientTip(names.client);
    out.push({mk:'處',tier:'free',passLock:!baljuPremium,teaser:`<b>${names.client||'발주처'}</b> 프리미엄 — 3계·실전 시나리오·주의신호·연도 세운이 열립니다.`,t:`${nm}${cm.t}`,html:baljuHtml(cm,c,names.client||'발주처',tip,!!baljuPremium)});}
  return out;
}
// [合 동업·협정] 카테고리 섹션 빌더
function secGunghap(x:any):any[]{
  ...
  if(partnerChart){const cm=compatWith(c,partnerChart,DONGUP,'대표님','동업 상대',seunSelf);
    out.push({mk:'同點',tier:'free',t:`${names.partner||'상대 대표'}${josa(names.partner||'상대 대표','과')}의 동업 궁합 — ${cm.score2}점 ${cm.grade}`,html:compatFreeHtml(cm,c,names.partner||'동업 상대','동업')});
    out.push({mk:'同',tier:'full',teaser:`장기 동업 적합도 ${QV(2)} · 역할은 대표님 ${QV(4)} × 상대 ${QV(4)} — 스트레스가 터지는 지점과 깨지지 않게 나누는 3계가 여기 있습니다.`,t:`동업 · ${names.partner||'상대 대표'} — ${cm.t}`,html:compatBlock(cm,c,names.partner||'동업 상대','partner','깨지지 않게 나누는 3계')});}
  if(allyChart){const cm=compatWith(c,allyChart,HYEOPJEONG,'우리 법인','상대 회사',seunSelf);
    out.push({mk:'協點',tier:'free',t:`${names.ally||'상대 회사'}${josa(names.ally||'상대 회사','과')}의 협정 궁합 — ${cm.score2}점 ${cm.grade}`,html:compatFreeHtml(cm,c,names.ally||'상대 회사','협정')});
    out.push({mk:'協',tier:'full',teaser:`회사 역할은 우리 ${QV(4)} × 상대 ${QV(4)}, 장기 협정 적합도 ${QV(2)} — 주관사·지분·계약 전 반드시 짚을 3계가 여기 있습니다.`,t:`협정 · ${names.ally||'상대 회사'} — ${cm.t}`,html:compatBlock(cm,c,names.ally||'상대 회사','ally','계약 전 반드시 짚을 3계')});}
  return out;
}
// [代 方士] 카테고리 섹션 빌더
function secDaepyoPlace(x:any):any[]{
  const {c,today,s,worryTxt,clientChart,legalChart,partnerChart,allyChart,level,names,daeunMeta,nowYMD,selYear,seunSelf,clientCore,me,gan,sip,dom,strong,weak,zero,P,unlocked,preciseOn,baljuPremium}=x;
  const out:any[]=[];
  out.push({mk:'方',tier:'full',teaser:`대표님께 기운을 돋우는 방면은 ${QV(2)}쪽, 행운 숫자 ${QV(3)}, 색 ${QV(4)} — 현장·발주처·사무실을 고르는 기준이 여기 있습니다.`,t:`${DIR_EL[weak]} 방면이 대표님의 부족한 기운을 채웁니다`,html:P([
...
function buildReport(c,today,s,worryTxt,clientChart,legalChart,partnerChart,allyChart,level,names,daeunMeta,nowYMD,selYear?,seunSelf?,clientCore?,baljuPremium?){
  names=names||{};
  ...
  const x:any={c,today,s,worryTxt,clientChart,legalChart,partnerChart,allyChart,level,names,daeunMeta,nowYMD,selYear,seunSelf,clientCore,me,gan,sip,dom,strong,weak,zero,P,unlocked,preciseOn,baljuPremium:!!baljuPremium};
  const secs=[
  ...
  return secs.map((sec:any)=>({
    ...
    teaser: sec.teaser, gauge: sec.gauge, passLock: sec.passLock,
  }));
}

export type Section = { mk:string; free:boolean; tier:'free'|'taekil'|'full'; t:string; html:string; teaser?:string; gauge?:boolean; passLock?:boolean };
...
export function reportHeroFor(cat:string|undefined, ctx:any):Hero{
  ...
  if(cat==='calendar'||cat==='calendar_year'){
    ...
    if(cat==='calendar_year'){
      // 올해를 9월에 보면 남은 달은 4개월이다 — '12개월'이라고 크게 쓰면 받는 것과 말이 어긋난다
      const yy=ctx.selYear||y; const left=(nowYMD&&yy===y)?13-(m||1):12;
      return {score:0,big:String(left),unit:'개월',label:left<12?`남은 ${yy}년 사업운 흐름`:`${yy}년 사업운 흐름`,
        headline:left<12?`남은 ${yy}년, <b>밀어주는 달</b>에 큰 판을 거십시오`:'올 한 해, <b>밀어주는 달</b>에 큰 판을 거십시오',
...
export function buildTiered(
  ...
  selYear?:number, seunSelf?:any, clientCore?:boolean, baljuPremium?:boolean
):Section[]{
