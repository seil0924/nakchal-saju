  ...
  return (
    <div className="app home">
      ...
      <div style={{ padding: '18px 18px 4px' }}>
        <div style={{ fontSize: 12, letterSpacing: '.28em', color: '#a99f88', fontWeight: 700, marginBottom: 6 }}>SAMPLE 四柱</div>
          ...
          <div key={i} style={{ background: '#fff', border: '1px solid var(--line)', borderRadius: 16, padding: '16px 17px', marginBottom: 13 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 11, marginBottom: 10 }}>
              ...
              <div style={{ marginLeft: 'auto', textAlign: 'right' }}>
                ...
                <div style={{ fontSize: 12, color: '#a99f88' }}>오늘의 신호</div>
              </div>
            </div>
        ...
        <p style={{ fontSize: 12, color: '#a99f88', lineHeight: 1.65, margin: '14px 0 22px' }}>※ 위 사례는 이해를 돕기 위한 가상 예시입니다. 실제 인물과 무관하며, 명리 기반 참고·오락용 정보입니다.</p>
      </div>
    </div>
  );
}
