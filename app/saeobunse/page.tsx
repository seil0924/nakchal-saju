...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/saeobunse' },
  openGraph: { title: '2026 병오년 12지신 사업·입찰운세', description: '띠별 올해의 수주 흐름과 실전 수칙', type: 'article', siteName: '낙찰사주', url: BASE + '/saeobunse' },
};
...
const TTI = [
  ...
  { a: '호랑이띠', h: '寅', y: '62·74·86·98·10년생', flow: '木生火 — 불을 지피는 나무. 추진력이 최고조에 이릅니다.', tip: '신규 진출·공격적 투찰 유리. 단, 마진 얇은 저가 투찰은 경계.' },
  ...
  { a: '돼지띠', h: '亥', y: '71·83·95·07·19년생', flow: '水의 해 — 火와 상반, 재충전·준비의 시기.', tip: '큰 승부보다 내년 준비. 관계·정보를 축적하며 힘을 아끼세요.' },
];
...
export default function SaeobUnsePage() {
  const jsonld = {
    ...
    inLanguage: 'ko', datePublished: '2026-01-01', mainEntityOfPage: BASE + '/saeobunse',
  };
  return (
