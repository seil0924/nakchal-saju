...
export default function Home() {
  ...
  return (
    <div className="app home5">
      ...
      {/* 후기 띠 — 수록 규모 바로 아래, 「사주별로 골라 보기」 위.
          자리는 DOM 이 아니라 krds-normalize.css 의 flex order 가 정한다 — order 를 안 주면
          catch-all(order:6)에 걸려 페이지 꼬리로 밀린다. 여기 순서만 바꿔선 아무 일도 안 일어난다.
