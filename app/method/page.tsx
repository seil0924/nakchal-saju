  ...
  return (
    <div className="app home">
      ...
      <div style={{ padding: '18px 18px 4px' }}>
        <div style={{ fontSize: 13, letterSpacing: '.28em', color: '#6d7882', fontWeight: 700, marginBottom: 6 }}>計算 方法論</div>
        ...
        <p style={{ fontSize: 13, color: '#6d7882', lineHeight: 1.65, marginBottom: 20 }}>※ 만세력 계산의 정확도를 높인 것이며, 해석과 예측은 명리 이론에 기반한 참고·오락용 정보입니다.</p>
      </div>
    </div>
  );
}
