  ...
  return (
    <div className="app home">
      ...
      <div style={{ padding: '40px 22px 24px', textAlign: 'center' }}>
        ...
        <div style={{ fontSize: 12, letterSpacing: '.28em', color: '#6d7882', fontWeight: 700, marginBottom: 8 }}>結濟 完了</div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10, maxWidth: 360, margin: '0 auto' }}>
          <Link href="/reading" style={{ display: 'block', textAlign: 'center', background: 'linear-gradient(135deg,var(--red),#7f1a17)', color: '#fff', border: '1px solid var(--gold2)', borderRadius: 14, padding: '15px', fontFamily: 'var(--serif)', fontWeight: 900, fontSize: 16, textDecoration: 'none' }}>오늘의 투찰 택일 보기 →</Link>
          ...
          <Link href="/" style={{ display: 'block', textAlign: 'center', color: '#58616a', padding: '8px', fontSize: 13.5, fontWeight: 600, textDecoration: 'none' }}>홈으로 돌아가기</Link>
        </div>

        {/* 후기를 청하는 자리는 여기다. 결제 직후가 유일하게 「써 봤다」가 확실한 시점이라,
            후기가 실제로 들어오는 통로가 이 링크 하나뿐이다. */}
        <p style={{ fontSize: 12.5, color: '#58616a', lineHeight: 1.7, margin: '22px auto 0', maxWidth: 340 }}>
          써 보신 뒤 한 줄 남겨 주시면 다음 대표님께 도움이 됩니다 —{' '}
          <Link href="/review" style={{ color: 'var(--navy)', fontWeight: 700 }}>후기 남기기</Link>
        </p>

        <p style={{ fontSize: 12, color: '#6d7882', lineHeight: 1.65, margin: '26px auto 0', maxWidth: 340 }}>영수증·결제 내역은 결제하신 카드사/간편결제 앱에서 확인하실 수 있습니다. 문의는 사이트 하단 연락처로 남겨주세요.</p>
      </div>
    </div>
  );
}
